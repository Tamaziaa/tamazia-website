// Case Studies · 3 alternating panels · verbatim live tamazia.in (TAMAZIA-13 §4)
// CRITICAL FIX: Case I = Orchid Hotels (was incorrectly Kamat with invented £1.2M).
// CRITICAL FIX: Meraas panel restored with Sheikh Mohammed directive framing.
//
...
// current CaseStudies.astro component until Gate D rewrites the component.
...
const cgoncMetrics = [
  ...
  { value: 'NYSE', label: 'Listed: CGON',                note: '' },
  { value: 'Zero', label: 'Compliance incidents',        note: '' },
];
...
export const caseStudiesContent = {
  ...
  cases: [
    {
      ...
      // New schema (used by Gate D component upgrade)
    ...
    },
    {
      ...
      body: 'A piece of digital content published at the wrong moment, with the wrong framing, is not an SEO mistake. It is an SEC Regulation FD violation. CG Oncology was preparing for its NYSE listing. Every piece of content had to be accurate on the science, correct on the financials, and clean under SEC disclosure rules simultaneously. CG Oncology listed on the NYSE as CGON. Shares nearly doubled, a 96% increase at IPO. Every piece of content Tamazia produced was published without a single compliance incident.',
      stat: '+96%',
      statCaption: 'NYSE IPO SHARE PRICE MOVEMENT · CG ONCOLOGY (CGON)',
  ...
  // Legacy field still consumed by current component
  closingPullQuote:
