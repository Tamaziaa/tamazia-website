...
If your firm has not run an SRA Transparency audit in 2026, run one this quarter. The findings are yours regardless of whether your current SEO agency knows what to do with them.`,
  ...
  { slug: 'medical-tourism-source-market', title: 'Medical Tourism SEO: Source-Market Intent and Destination Authority',                  sector: 'Healthcare and Medical', sectorSlug: 'healthcare', regulator: 'Hreflang · MOHAP',     status: 'in-preparation', excerpt: 'Capturing UK + GCC patient flows for UAE and Gulf destination clinics.' },
